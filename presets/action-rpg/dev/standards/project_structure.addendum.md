...
preset's `common/gameplay/{store,snapshot,service,instance}` archetype tree with an
...
## `global/autoload/` — real-time infra
...
There is no Store/Manager layer — entity state lives on the entity's components.
