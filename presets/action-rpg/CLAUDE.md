...
This file is the action-rpg preset entry point for Claude-style agents that discover `CLAUDE.md`.
...
This preset overlays real-time, spatial, component-driven action-RPG conventions on the base template. Detailed architecture and task-specific rules live in the base startup file and this preset's standards.
